...
while(numeri_consentiti.length < possibilita && array_random.includes(numero_utente) == false ) {
    ...
    if (array_random.includes(numero_utente) == false ) {
        ...
        console.log('Hai colpito la bomba con il numero ' + numero_utente)//partita termina quando il giocatore becca una mina, ossia inserisce un numero "vietato", oppure se raggiunge il numero massimo possibile di numeri consentiti, ossia ha inserito tutti i numeri possibili che non sono mine!
    }
}
